 ...
 */
public class ReversePathHierarchyTokenizerBuilder extends TokenizerBuilder<ReversePathHierarchyTokenizer> {
     ...
     */
    @JsonCreator
    public ReversePathHierarchyTokenizerBuilder(@JsonProperty("buffer_size") Integer bufferSize,
    ...
    /** {@inheritDoc} */
    @Override
    public ReversePathHierarchyTokenizer buildTokenizer() {
