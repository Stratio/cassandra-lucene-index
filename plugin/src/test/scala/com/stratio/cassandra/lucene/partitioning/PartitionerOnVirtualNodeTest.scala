...
class PartitionerOnVirtualNodeTest extends PartitionerTest {
  ...
  test("key partition with 1 partition") {
    val tokens=List(-9223372036854775808l, -7378697629483820647l, -5534023222112865486l, -3689348814741910325l, -1844674407370955164l,
      -3l, 1844674407370955158l, 3689348814741910319l, 5534023222112865480l ,7378697629483820641l).map(new Murmur3Partitioner.LongToken(_))
