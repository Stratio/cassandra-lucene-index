...
public class IntegerMapperTest extends AbstractMapperTest {
    ...
    public void testConstructorWithAllArgs() {
        IntegerMapper mapper = integerMapper().validated(true).column("column").build("field");
        assertEquals("Field is not properly set", "field", mapper.field);
    ...
    public void testJsonSerialization() {
        IntegerMapperBuilder builder = integerMapper().validated(true).column("column");
        testJson(builder, "{type:\"integer\",validated:true,column:\"column\"}");
    }
    ...
    public void testToString() {
        IntegerMapper mapper = integerMapper().validated(true).build("field");
        assertEquals("Method #toString is wrong",
                     "IntegerMapper{field=field, validated=true, column=field}",
                     mapper.toString());
    }
}
