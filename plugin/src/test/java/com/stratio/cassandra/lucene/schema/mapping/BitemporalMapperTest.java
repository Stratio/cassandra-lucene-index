...
public class BitemporalMapperTest {
    ...
    public void testConstructorWithAllArgs() {
        ...
        BitemporalMapper mapper = new BitemporalMapper("field", "vtFrom", "vtTo", "ttFrom", "ttTo", "yyyy/MM/dd","2021/03/11");
        assertEquals("field", mapper.getName());
        assertTrue(mapper.isIndexed());
        assertFalse(mapper.isSorted());
        assertEquals("vtFrom", mapper.getVtFrom());
    ...
    public void testGetVtFromStringColumnWithCustomPattern() throws ParseException {
        ...
        BitemporalMapper mapper = new BitemporalMapper("field", "vt_from", "vt_to", "tt_from", "tt_to", "yyyy-MM-dd","2025-12-23");
    ...
    public void testParseJSONWithDefaultArgs() throws IOException {
        String json = "{fields:{temporal:{type:\"bitemporal\", vt_from:\"vtFrom\", vt_to:\"vtTo\", tt_from:\"ttFrom\", tt_to:\"ttTo\"}}}";
    ...
    public void testParseJSONWithAllArgs() throws IOException {
        String json = "{fields:{temporal:{type:\"bitemporal\", vt_from:\"vtFrom\", vt_to:\"vtTo\", tt_from:\"ttFrom\", tt_to:\"ttTo\", pattern:\"yyyy/MM/dd\"}}}";
        Schema schema = SchemaBuilder.fromJson(json).build();
        BitemporalMapper mapper = (BitemporalMapper) schema.getMapper("temporal");
        assertEquals(BitemporalMapper.class, mapper.getClass());
        assertEquals("temporal", mapper.getName());
    ...
    public void testToString() {
        BitemporalMapper mapper = new BitemporalMapper("field", "vtFrom", "vtTo", "ttFrom", "ttTo", "yyyy/MM/dd","2025/12/23");
        String exp = "BitemporalMapper{name=field, vtFrom=vtFrom, vtTo=vtTo, ttFrom=ttFrom, ttTo=ttTo, pattern=yyyy/MM/dd, nowValue=1766444400000}";
