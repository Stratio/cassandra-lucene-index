...
public class TokenizerBuilderTest {
    ...
    private <T> T assertBuilderAndTokenizer(String json, Class expectedBuilderClass, Class expectedTokenizerClass) {
        try {
            ...
            assertEquals("Expected " + expectedBuilderClass.getName() + " class", expectedBuilderClass, abstractBuilder.getClass());
            Tokenizer tokenizer = abstractBuilder.buildTokenizer();
            assertEquals("Expected " + expectedTokenizerClass.getName() + " class", expectedTokenizerClass, tokenizer.getClass());
    ...
    private void assertJsonParseFail(String json, String message) {
        try {
            ...
            assertEquals("Expected IOException with message: " + message + " but received: " + e.getMessage() + " localMess: " + e.getLocalizedMessage(), message, e.getMessage());
        }
        assertFalse("Parsing: " + json + " must generate an IOException with message: " + message + " but does not.", true);
    }

    private void assertExactValue(String paramName, Object expected, Object received) {
        assertEquals("Expected " + paramName + " equals to " + expected.toString() + " but received: " + received.toString(), expected, received);
    }

    @Test
    public void testClassicTokenizerValidJSON() {
        String json = "{type: \"classic\", max_token_length: 250}";
        ClassicTokenizerBuilder builder = assertBuilderAndTokenizer(json, ClassicTokenizerBuilder.class, ClassicTokenizer.class);
    ...
    public void testClassicTokenizerDefaultValues() {
        ClassicTokenizerBuilder builder = assertBuilderAndTokenizer("{type: \"classic\"}", ClassicTokenizerBuilder.class, ClassicTokenizer.class);
        assertExactValue("ClassicTokenizerBuilder.maxTokenLength", ClassicTokenizerBuilder.DEFAULT_MAX_TOKEN_LENGTH, builder.maxTokenLength);
    }
    ...
    public void testKeywordTokenizerValidJSON() {
        ...
        KeywordTokenizerBuilder builder = assertBuilderAndTokenizer(json, KeywordTokenizerBuilder.class, KeywordTokenizer.class);
        assertExactValue("KeywordTokenizer.bufferSize", 256, builder.bufferSize);
    }

    @Test
    public void testKeywordTokenizerDefaultValues() {
        KeywordTokenizerBuilder builder = assertBuilderAndTokenizer("{type: \"keyword\"}", KeywordTokenizerBuilder.class, KeywordTokenizer.class);
        assertExactValue("ClassicTokenizerBuilder.maxTokenLength", KeywordTokenizerBuilder.DEFAULT_BUFFER_SIZE, builder.bufferSize);
    }
    ...
    public void testNGramTokenizerValidJSON() {
        ...
        assertExactValue("NGramTokenizerBuilder.min_gram", 1, builder.minGram);
        assertExactValue("NGramTokenizerBuilder.max_gram", 1, builder.maxGram);
    }
    ...
    public void testPathHierarchyTokenizerValidJSON() {
        ...
        PathHierarchyTokenizerBuilder builder = assertBuilderAndTokenizer(json, PathHierarchyTokenizerBuilder.class, PathHierarchyTokenizer.class);
    ...
    public void testPathHierarchyTokenizerDefaultValues() {
        ...
        PathHierarchyTokenizerBuilder builder = assertBuilderAndTokenizer(json, PathHierarchyTokenizerBuilder.class, PathHierarchyTokenizer.class);
        assertExactValue("PathHierarchyTokenizerBuilder.buffer_size", PathHierarchyTokenizerBuilder.DEFAULT_BUFFER_SIZE, builder.bufferSize);
        assertExactValue("PathHierarchyTokenizerBuilder.delimiter", PathHierarchyTokenizerBuilder.DEFAULT_DELIMITER, builder.delimiter);
        assertExactValue("PathHierarchyTokenizerBuilder.replacement", PathHierarchyTokenizerBuilder.DEFAULT_REPLACEMENT, builder.replacement);
        assertExactValue("PathHierarchyTokenizerBuilder.skip", PathHierarchyTokenizerBuilder.DEFAULT_SKIP, builder.skip);
    }
    ...
    public void testPatternTokenizerValidJSON() {
        ...
        PatternTokenizerBuilder builder = assertBuilderAndTokenizer(json, PatternTokenizerBuilder.class, PatternTokenizer.class);
    ...
    public void testPatternTokenizerDefaultValues() {
        ...
        PatternTokenizerBuilder builder = assertBuilderAndTokenizer(json, PatternTokenizerBuilder.class, PatternTokenizer.class);
        assertExactValue("PathHierarchyTokenizerBuilder.pattern", PatternTokenizerBuilder.DEFAULT_PATTERN, builder.pattern);
    ...
    public void testReversePathHierarchyTokenizerValidJSON() {
        String json = "{type: \"reverse_path_hierarchy\", buffer_size: 246, delimiter: \"/\", replacement: \"%\", skip: 3}";
        ReversePathHierarchyTokenizerBuilder builder = assertBuilderAndTokenizer(json, ReversePathHierarchyTokenizerBuilder.class, ReversePathHierarchyTokenizer.class);
    ...
    public void testReversePathHierarchyTokenizerDefaultValues() {
        ...
        ReversePathHierarchyTokenizerBuilder builder = assertBuilderAndTokenizer(json, ReversePathHierarchyTokenizerBuilder.class, ReversePathHierarchyTokenizer.class);
        assertExactValue("PathHierarchyTokenizerBuilder.buffer_size", ReversePathHierarchyTokenizerBuilder.DEFAULT_BUFFER_SIZE, builder.bufferSize);
        assertExactValue("PathHierarchyTokenizerBuilder.delimiter", ReversePathHierarchyTokenizerBuilder.DEFAULT_DELIMITER, builder.delimiter);
        assertExactValue("PathHierarchyTokenizerBuilder.replacement", ReversePathHierarchyTokenizerBuilder.DEFAULT_REPLACEMENT, builder.replacement);
        assertExactValue("PathHierarchyTokenizerBuilder.skip", ReversePathHierarchyTokenizerBuilder.DEFAULT_SKIP, builder.skip);
    }

    @Test(expected = IOException.class)
    public void testReversePathHierarchyTokenizerInvalidJSON() throws IOException {
        assertJsonParseFail("{type: \"reverse_path_hierarchy\", buffer_size: 246, delimiter: \"/\", replacent: \"%\", skip: 3}");
    }

    @Test
    public void testStandardTokenizerValidJSON() {
        String json = "{type: \"standard\", max_token_length: 246}";
        StandardTokenizerBuilder builder = assertBuilderAndTokenizer(json, StandardTokenizerBuilder.class, StandardTokenizer.class);
    ...
    public void testStandardTokenizerDefaultValues() {
        StandardTokenizerBuilder builder = assertBuilderAndTokenizer("{type: \"standard\"}", StandardTokenizerBuilder.class, StandardTokenizer.class);
        assertExactValue("ClassicTokenizerBuilder.maxTokenLength", StandardTokenizerBuilder.DEFAULT_MAX_TOKEN_LENGTH, builder.maxTokenLength);
    }
    ...
    public void testUAX29URLEmailTokenizerValidJSON() {
        ...
        UAX29URLEmailTokenizerBuilder builder = assertBuilderAndTokenizer(json, UAX29URLEmailTokenizerBuilder.class, UAX29URLEmailTokenizer.class);
    ...
    public void testUAX29URLEmailTokenizerDefaultValues() {
        ...
        UAX29URLEmailTokenizerBuilder builder = assertBuilderAndTokenizer(json, UAX29URLEmailTokenizerBuilder.class, UAX29URLEmailTokenizer.class);
        assertExactValue("UAX29URLEmailTokenizerBuilder.maxTokenLength", UAX29URLEmailTokenizerBuilder.DEFAULT_MAX_TOKEN_LENGTH, builder.maxTokenLength);
    }
    ...
    public void testWikipediaTokenizerValidJSON() {
        ...
        WikipediaTokenizerBuilder builder = assertBuilderAndTokenizer(json, WikipediaTokenizerBuilder.class, WikipediaTokenizer.class);
        assertExactValue("WikipediaTokenizerBuilder.token_output", WikipediaTokenizerBuilder.TokenOutputValue.TOKENS_ONLY, builder.tokenOutput);
        assertExactValue("WikipediaTokenizerBuilder.untokenized_types", Sets.newHashSet("aaa", "bbb"), builder.untokenizedTypes);
    }
