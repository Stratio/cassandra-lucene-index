...
public class GeoShapeConditionTest extends AbstractConditionTest {
    ...
    public void testQueryIsWithIn() {
        ...
        assertEquals("Query is wrong", "WithinPrefixTreeFilter(fieldName=geo_point.dist,queryShape=" +
                                       "POLYGON ((1 1, 5 1, 5 5, 1 5, 1 1), (2 2, 3 2, 3 3, 2 3, 2 2))," +
                                       "detailLevel=8,prefixGridScanLevel=4)", withinPrefixTreeFilter.toString());
    }
    ...
    public void testQueryIntersects() {
        ...
        assertEquals("Query is wrong", "IntersectsPrefixTreeFilter(fieldName=geo_point.dist," +
                                       "queryShape=POLYGON ((1 1, 5 1, 5 5, 1 5, 1 1), (2 2, 3 2, 3 3, 2 3, 2 2))," +
                                       "detailLevel=8,prefixGridScanLevel=4)", intersectsPrefixTreeFilter.toString());
    ...
    public void testQueryContains() {
        ...
        assertEquals("Query is wrong",
                     "ContainsPrefixTreeFilter(fieldName=geo_point.dist,queryShape=" +
                     "POLYGON ((1 1, 5 1, 5 5, 1 5, 1 1), (2 2, 3 2, 3 3, 2 3, 2 2))," +
                     "detailLevel=8,multiOverlappingIndexedShapes=true)",
