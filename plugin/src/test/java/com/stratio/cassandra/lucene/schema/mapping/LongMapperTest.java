...
public class LongMapperTest extends AbstractMapperTest {
    ...
    public void testConstructorWithAllArgs() {
        LongMapper mapper = longMapper().validated(true).column("column").build("field");
        assertEquals("Field is not set", "field", mapper.field);
    ...
    public void testJsonSerialization() {
        LongMapperBuilder builder = longMapper().validated(true).column("column");
        testJson(builder, "{type:\"long\",validated:true,column:\"column\"}");
    }
    ...
    public void testToString() {
        LongMapper mapper = longMapper().validated(true).build("field");
        assertEquals("Method #toString is wrong",
                     "LongMapper{field=field, validated=true, column=field}",
                     mapper.toString());
    }
}
