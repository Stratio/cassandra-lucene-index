...
public class BigIntegerMapperTest extends AbstractMapperTest {
    ...
    public void testConstructorWithAllArgs() {
        BigIntegerMapper mapper = bigIntegerMapper().validated(true).column("column").digits(6).build("field");
        assertEquals("Field is not properly set", "field", mapper.field);
    ...
    public void testJsonSerialization() {
        BigIntegerMapperBuilder builder = bigIntegerMapper().validated(true).column("column").digits(6);
        testJson(builder, "{type:\"bigint\",validated:true,column:\"column\",digits:6}");
    }
    ...
    public void testToString() {
        ...
        assertEquals("Method #toString is wrong",
                     "BigIntegerMapper{field=field, validated=false, column=field, digits=8}",
                     mapper.toString());
    }
}
