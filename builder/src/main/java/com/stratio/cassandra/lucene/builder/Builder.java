...
import com.stratio.cassandra.lucene.builder.index.*;
import com.stratio.cassandra.lucene.builder.index.schema.*;
import com.stratio.cassandra.lucene.builder.index.schema.analysis.*;
import com.stratio.cassandra.lucene.builder.index.schema.mapping.*;
import com.stratio.cassandra.lucene.builder.search.*;
import com.stratio.cassandra.lucene.builder.search.condition.*;
import com.stratio.cassandra.lucene.builder.search.sort.*;
