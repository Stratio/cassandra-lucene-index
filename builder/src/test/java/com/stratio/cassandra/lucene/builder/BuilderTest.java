...
public class BuilderTest {
    ...
    public void testBooleanConditionFull() {
        ...
        String expected = "{type:\"boolean\",boost:2.0,must:[{type:\"all\"}],should:[{type:\"none\"}],not:[]}";
        assertEquals("boolean is wrong", expected, actual);
    }
    ...
    public void testFuzzyConditionFull() {
        String actual = fuzzy("field", "value").maxEdits(1).maxExpansions(2).prefixLength(3).transpositions(true).boost(
                2).build();
        String expected = "{type:\"fuzzy\",field:\"field\",value:\"value\",boost:2.0,transpositions:true," +
                          "max_edits:1,prefix_length:3,max_expansions:2}";
        assertEquals("fuzzy condition serialization is wrong", expected, actual);
    }
    ...
    public void testGeoBBoxConditionDefaults() {
        ...
        String expected = "{type:\"geo_bbox\",field:\"field\"," +
                          "min_latitude:3.0,max_latitude:4.0,min_longitude:1.0,max_longitude:2.0}";
        assertEquals("wildcard condition serialization is wrong", expected, actual);
    }
    ...
    public void testGeoBBoConditionFull() {
        ...
        String expected = "{type:\"geo_bbox\",field:\"field\"," +
                          "min_latitude:3.0,max_latitude:4.0,min_longitude:1.0,max_longitude:2.0,boost:1.0}";
        assertEquals("wildcard condition serialization is wrong", expected, actual);
    }
