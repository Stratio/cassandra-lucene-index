...
public class UDTIndexingTest {
    ...
    public static void before() {
        ...
        cassandraUtils = CassandraUtils.builder("udt_indexing").withTable(TestingConstants.TABLE_NAME_CONSTANT).build();
        ...
        cassandraUtils.execute(geoPointUDT.build());
        ...
        cassandraUtils.execute(insert7);
