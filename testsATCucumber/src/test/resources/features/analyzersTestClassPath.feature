...
Scenario: Create a snowball analyzer
    Given I create a Cassandra index named 'classpathMap' with schema 'schemas/analyzers/classpath.conf' of type 'string' in table 'analyzertable' using magic_column 'lucene' using keyspace 'opera' with:
		    | __analyzerName | UPDATE  | classpath |
		    | __class | UPDATE  | org.apache.lucene.analysis.en.EnglishAnalyzer |
