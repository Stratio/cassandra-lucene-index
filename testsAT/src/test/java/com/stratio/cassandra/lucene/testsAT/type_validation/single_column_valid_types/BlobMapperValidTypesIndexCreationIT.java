...
public class BlobMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "blob";
    ...
    public BlobMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
