...
public class InetMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "inet";
    ...
    public InetMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
