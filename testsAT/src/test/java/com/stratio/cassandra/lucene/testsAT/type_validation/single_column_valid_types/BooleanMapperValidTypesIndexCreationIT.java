...
public class BooleanMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "boolean";
    ...
    public BooleanMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
