...
public class UUIDMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "uuid";
    ...
    public UUIDMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
