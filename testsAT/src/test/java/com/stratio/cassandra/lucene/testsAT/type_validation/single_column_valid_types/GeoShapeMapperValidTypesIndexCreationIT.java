...
public class GeoShapeMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "geo_shape";
    ...
    public GeoShapeMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
