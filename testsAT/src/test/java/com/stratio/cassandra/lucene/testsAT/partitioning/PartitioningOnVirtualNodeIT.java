...
/**
 * Test index partitioning on virtual node. This test class ignores some tests if cassandra target cluster is not configured with virtual tokens (numTokens in cassandra.yaml).
 *
