...
public class FloatMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "float";
    ...
    public FloatMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
