...
/**
 * Acceptance tests for range query using doc values.
 *
 * @author Andres de la Pena <adelapena@stratio.com>
 */
@RunWith(JUnit4.class)
public class RangeSearchWithDocValuesAT extends AbstractSearchAT {
    ...
    public void rangeQueryTextFieldTest1() {
        query(range("text_1")).check(InvalidQueryException.class, UNSUPPORTED_DOC_VALUES);
    }

    @Test
    public void rangeQueryTextFieldTest2() {
        query(range("text_1").lower("frase").upper("g")).check(InvalidQueryException.class, UNSUPPORTED_DOC_VALUES);
    }
    ...
    public void rangeQueryTextFieldTest3() {
        query(range("text_1").lower("frasesinespaciosconarticulosylaspalabrassuficientesperomaslarga")
                             .upper("g")).check(InvalidQueryException.class, UNSUPPORTED_DOC_VALUES);
    }
    ...
    public void rangeQueryTextFieldTest4() {
        query(range("text_1").lower("frasesinespaciosconarticulosylaspalabrassuficientesperomaslarga")
                             .upper("g")
                             .includeLower(true)
                             .includeUpper(true)).check(InvalidQueryException.class, UNSUPPORTED_DOC_VALUES);
    }

    @Test
    public void rangeQueryTextFieldTest5() {
        query(range("text_1").lower("G")
                             .upper("H")
                             .includeLower(true)
                             .includeUpper(true)).check(InvalidQueryException.class, UNSUPPORTED_DOC_VALUES);
    }
    ...
    public void rangeQueryListFieldTest1() {
        query(range("string_list").lower("a").upper("z")).check(5);
    }

    @Test
    public void rangeQueryListFieldTest2() {
        query(range("string_list").lower("a1").upper("z9")).check(5);
    }

    @Test
    public void rangeQueryListFieldTest3() {
        query(range("string_list").lower("a2").upper("l1")).check(0);
    }

    @Test
    public void rangeQuerySetFieldTest1() {
        query(range("string_set").lower("a").upper("z")).check(5);
    }

    @Test
    public void rangeQuerySetFieldTest2() {
        query(range("string_set").lower("a1").upper("z9")).check(5);
    }

    @Test
    public void rangeQuerySetFieldTest3() {
        query(range("string_set").lower("a1").upper("z1")).check(5);
    }
    ...
    public void rangeFilterTextFieldTest2() {
        filter(range("text_1").lower("frase").upper("g")).check(InvalidQueryException.class,
