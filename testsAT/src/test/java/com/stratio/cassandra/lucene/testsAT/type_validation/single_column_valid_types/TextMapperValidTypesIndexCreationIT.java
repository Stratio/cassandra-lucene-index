...
public class TextMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "text";
    ...
    public TextMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
