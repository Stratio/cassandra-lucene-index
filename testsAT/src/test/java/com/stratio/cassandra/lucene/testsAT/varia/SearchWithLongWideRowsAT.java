...
public class SearchWithLongWideRowsAT extends BaseAT {
    ...
    public void query99Test() {
        int n = utils.query(match("partition", 0)).fetchSize(10).limit(99).count();
        assertEquals("Expected 99 results!", 99, n);
    }

    @Test
    public void query100Test() {
        int n = utils.query(match("partition", 0)).fetchSize(10).limit(100).count();
        assertEquals("Expected 100 results!", 100, n);
    }

    @Test
    public void query101Test() {
        int n = utils.query(match("partition", 0)).fetchSize(10).limit(101).count();
        assertEquals("Expected 100 results!", 100, n);
    }

    @Test
    public void query1000Test() {
        int n = utils.query(match("partition", 0)).fetchSize(10).limit(1000).count();
        assertEquals("Expected 100 results!", 100, n);
    }

    @Test
    public void queryAll200Test() {
        int n = utils.query(all()).limit(200).fetchSize(7).count();
        assertEquals("Expected 200 results!", 200, n);
    }

    @Test
    public void queryAll1200Test() {
        int n = utils.query(all()).limit(201).fetchSize(4).count();
        assertEquals("Expected 200 results!", 200, n);
    }

    @Test
    public void queryAll199Test() {
        int n = utils.query(all()).limit(199).fetchSize(13).count();
        assertEquals("Expected 199 results!", 199, n);
    }

    @Test
    public void filter99Test() {
        int n = utils.filter(match("partition", 0)).fetchSize(10).limit(99).count();
        assertEquals("Expected 99 results!", 99, n);
    }

    @Test
    public void filter100Test() {
        int n = utils.filter(match("partition", 0)).fetchSize(10).limit(100).count();
        assertEquals("Expected 100 results!", 100, n);
    }

    @Test
    public void filter101Test() {
        int n = utils.filter(match("partition", 0)).fetchSize(10).limit(101).count();
        assertEquals("Expected 100 results!", 100, n);
    }

    @Test
    public void filter1000Test() {
        int n = utils.filter(match("partition", 0)).fetchSize(10).limit(1000).count();
        assertEquals("Expected 100 results!", 100, n);
    }

    @Test
    public void filterAll200Test() {
        int n = utils.filter(all()).limit(200).fetchSize(7).count();
        assertEquals("Expected 200 results!", 200, n);
    }

    @Test
    public void filterAll1200Test() {
        int n = utils.filter(all()).limit(201).fetchSize(4).count();
        assertEquals("Expected 200 results!", 200, n);
    }

    @Test
    public void filterAll199Test() {
        int n = utils.filter(all()).limit(199).fetchSize(13).count();
        assertEquals("Expected 199 results!", 199, n);
    }
}
