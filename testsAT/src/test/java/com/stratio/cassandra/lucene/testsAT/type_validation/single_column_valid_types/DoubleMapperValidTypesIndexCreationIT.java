...
public class DoubleMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "double";
    ...
    public DoubleMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
