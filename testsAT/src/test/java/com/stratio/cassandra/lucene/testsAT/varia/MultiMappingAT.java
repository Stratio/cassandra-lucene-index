...
public class MultiMappingAT extends BaseAT {
    ...
    public void testSimpleSort() {
        utils.select()
             .sort(field("text"))
             .checkOrderedColumns("text", String.class, "01-01-2014", "02-01-2013", "03-01-2012", "04-01-2011");
    }
    ...
    public void testAliasSort() {
        utils.select()
             ...
             .checkOrderedColumns("text", String.class, "04-01-2011", "03-01-2012", "02-01-2013", "01-01-2014");
