...
public class IntegerMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "integer";
    ...
    public IntegerMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
