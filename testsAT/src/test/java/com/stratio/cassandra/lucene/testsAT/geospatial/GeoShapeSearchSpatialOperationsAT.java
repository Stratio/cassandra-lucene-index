...
public class GeoShapeSearchSpatialOperationsAT extends BaseAT {
    ...
    public void testCase1() {
        ...
        cassandraUtils
                ...
                .checkUnorderedColumns("identity", String.class, "1")
    ...
    public void testCase2() {
        ...
        cassandraUtils.filter(geoShape.operation("contains"), match("search_case", search_case))
                      .checkUnorderedColumns("identity", String.class, "1", "2")
                      .filter(geoShape.operation("intersects"), match("search_case", search_case))
                      .checkUnorderedColumns("identity", String.class, "1", "2")
                      .filter(geoShape.operation("is_within"), match("search_case", search_case))
                      .check(0)
                      .filter(geoShape2.operation("contains"), match("search_case", search_case))
                      .checkUnorderedColumns("identity", String.class, "2")
    ...
    public void testCase3() {
        ...
        cassandraUtils.filter(geoShape.operation("contains"), match("search_case", search_case))
                      .checkUnorderedColumns("identity", String.class, "1")
                      .filter(geoShape.operation("intersects"), match("search_case", search_case))
                      .checkUnorderedColumns("identity", String.class, "1", "3")
                      .filter(geoShape.operation("is_within"), match("search_case", search_case))
                      .check(0)
                      .filter(geoShape3.operation("contains"), match("search_case", search_case))
                      .checkUnorderedColumns("identity", String.class, "3")
    ...
    public void testCase4() {
        ...
        cassandraUtils.filter(geoShape1.operation("contains"), match("search_case", search_case))
                      ...
                      .checkUnorderedColumns("identity", String.class, "1", "4")
                      ...
                      .checkUnorderedColumns("identity", String.class, "4")
    ...
    public void testCase5() {
        ...
        cassandraUtils.filter(geoShape1.operation("contains"), match("search_case", search_case))
                      ...
                      .checkUnorderedColumns("identity", String.class, "5")
