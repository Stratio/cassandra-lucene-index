...
public class BigDecimalMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "big_decimal";
    ...
    public BigDecimalMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
