...
public class DateMapperValidTypesIndexCreationIT extends BaseIT {

    private static final String MAPPER_TYPE= "date";
    ...
    public DateMapperValidTypesIndexCreationIT(String mapperName, Mapper mapper, String cqlType) {
