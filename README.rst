...
Examples
--------
Currently, there are two ways of create index and query them. Please see `Different ways to index and query <doc/documentation.rst#two-ways-of-indexing>`__.
